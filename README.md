...
**Hello Rails React** is a demo Rails project where I used js-building gem to integrate Webpack/React & Redux with rails
...
1. Clone this project using Git Bash: 
    ``` 
    git clone https://github.com/SelmaNdapanda/hello-rails-react.git
    ```
